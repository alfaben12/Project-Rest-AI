                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 d-none d-lg-flex align-items-center">
                            <img src="<?= base_url() ?>appassets/assets/img/illustrations/process.svg" class="w-100 mx-auto d-block img-fluid" alt="">
                        </div>
                        <div class="col-lg-6 d-flex align-items-center">
                            <div class="pl-0">
                                <div class="text-black mt-3">
                                    ...
                                    <p class="font-size-lg mb-4 text-black-50 text-right">
                                        - Peter F. Drucker
                                    </p>
                                    <div>
                                        <form id="loginForm">
                                    ...
                                    <small class="d-block text-black-50 pt-3">Belum mempunyai akun? Silahkan daftar <a href="<?= site_url('registers') ?>">disini</a></small>
                                </div>
                            </div>
                        </div>
                    </div>
